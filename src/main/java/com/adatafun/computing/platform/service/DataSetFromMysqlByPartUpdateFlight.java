...
//                map.put("travelPreference_flightSchedule", value.getField(1));
//                out.collect(map);
//
//            }
//        });
...
//                Map<String, Object> map = new HashMap<>();
//                map.put("longTengId", value.getField(0));
//                map.put("travelPreference_flightDistance", value.getField(1));
//                out.collect(map);
//
//            }
//        });
...
//                Map<String, Object> map = new HashMap<>();
//                map.put("longTengId", value.getField(0));
//                map.put("travelPreference_flightSegment", value.getField(1));
//                out.collect(map);
//
//            }
//        });
